...
@Component({
  ...
  template: `
    ...
    >
      <!-- Navigation Bar -->
      <nav
        class="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-lg border-b border-orange-500/20"
      >
        <div
          class="container mx-auto px-4 py-4 max-w-6xl flex items-center justify-between"
        >
          <div class="flex items-center gap-3">
            <div
              class="w-10 h-10 bg-gradient-to-br from-cyan-500 via-orange-500 to-red-500 rounded-lg flex items-center justify-center"
            >
      ...
      <section class="container mx-auto px-4 max-w-6xl pt-20 pb-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="space-y-8">
            <div class="space-y-4">
              <div
                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/50 mb-4"
              >
                <span
                  class="w-2 h-2 bg-orange-500 rounded-full animate-pulse"
                ></span>
                <span class="text-orange-400 font-semibold text-sm"
                  >Quantum Liquidity Engine</span
                >
              </div>
              <h1
                class="text-5xl lg:text-6xl font-bold text-white leading-tight"
              >
                Welcome to
                <span
                  class="bg-gradient-to-r from-cyan-400 via-orange-400 to-red-400 text-transparent bg-clip-text"
                >
                  DeFiniX</span
                >
              </h1>
              <p class="text-xl text-slate-300 leading-relaxed">
                World's first quantum Virtual Liquidity Engine (qLE) using
                virtual wallets and stablecoins. Experience seamless asset
                management with multi-chain support, instant conversions, and
          ...
          <div class="hidden lg:flex items-center justify-center">
            <div class="relative w-full aspect-square max-w-md">
              ...
              <div
                class="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-3xl blur-3xl"
              ></div>

              <!-- Card illustration -->
              <div class="absolute inset-0 flex items-center justify-center">
                <div
                  class="w-64 h-80 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-slate-700 p-6 shadow-2xl"
                >
                  <div class="flex items-center justify-between mb-8">
                    ...
                    >
                    <div
                      class="w-8 h-8 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full"
                    ></div>
                  </div>
      ...
      <section
        #featuresSection
        class="py-20 bg-slate-800/50 border-y border-slate-700"
      >
        <div class="container mx-auto px-4 max-w-6xl">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Feature 1 -->
            <div
              class="p-8 rounded-xl border border-slate-700 hover:border-cyan-500 transition-colors bg-slate-900/50"
            >
              <div
              ...
              <p class="text-slate-400">
                Create and manage multiple virtual wallets with customizable
                spending caps and security settings.
              </p>
            </div>

            <!-- Feature 2 -->
            <div
              class="p-8 rounded-xl border border-slate-700 hover:border-purple-500 transition-colors bg-slate-900/50"
            >
              <div
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 13m-5 4l-4 4m0 0l-4-4m4 4v-5"
                  ></path>
                </svg>
              </div>
              <h3 class="text-xl font-semibold text-white mb-2">
              ...
              <p class="text-slate-400">
                Convert between USDC and ETH instantly with minimal slippage and
            ...
            <!-- Feature 3 -->
            <div
              class="p-8 rounded-xl border border-slate-700 hover:border-green-500 transition-colors bg-slate-900/50"
            >
              <div
              ...
              <p class="text-slate-400">
                Bank-grade encryption and security protocols protect your assets
                with advanced smart contract verification.
              </p>
            </div>
          </div>
        </div>
      ...
      <!-- CTA Section -->
      <section
        class="py-20 bg-gradient-to-r from-cyan-600 via-orange-500 to-red-600"
      >
        <div class="container mx-auto px-4 max-w-4xl text-center">
          <h2 class="text-4xl font-bold text-white mb-4">
            Ready to Experience qLE?
          </h2>
          <p class="text-lg text-white mb-8">
            Join the quantum liquidity revolution with DeFiniX. Manage your
            virtual wallet across multiple chains securely and efficiently.
          </p>
          <button
            (click)="connectAndNavigate()"
            [disabled]="web3Service.isLoading()"
        ...
        <div class="container mx-auto px-4 max-w-6xl">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div class="flex items-center gap-3 mb-4">
                <div
                  class="w-8 h-8 bg-gradient-to-br from-cyan-500 via-orange-500 to-red-500 rounded-lg flex items-center justify-center"
                >
              ...
              <p class="text-slate-400 text-sm">
                World's first quantum Virtual Liquidity Engine using virtual
          ...
          <div class="border-t border-orange-500/20 pt-8">
            <p class="text-center text-slate-400 text-sm">
              © 2024 DeFiniX. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
...
export class HomeComponent {
  ...
  scrollToFeatures() {
    document
      .querySelector("[scroll-to-features]")
