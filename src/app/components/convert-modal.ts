        ...
        <div class="p-6 space-y-6">
          ...
          <div class="flex justify-center">
            ...
            >
              <svg class="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4M17 8v12m0 0l4-4m-4 4l-4-4"></path>
              </svg>
            </button>
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              ...
              <div class="w-24 px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white">
          ...
          <div class="bg-slate-700/50 rounded-lg p-4 space-y-2">
            <div class="flex justify-between text-sm">
              ...
              <span class="text-white font-semibold">1 {{ fromToken }} ≈ {{ rate() | number: '1.4-6' }} {{ toToken }}</span>
            </div>
            <div class="flex justify-between text-sm">
              <span class="text-slate-400">Min Receive:</span>
              <span class="text-white font-semibold">{{ minToAmount() | number: '1.2-6' }} {{ toToken }}</span>
            </div>
            <div class="flex justify-between text-sm">
          ...
          <button
            ...
            [disabled]="isProcessing() || !fromToken || !toToken || !fromAmount || fromAmount <= 0 || fromToken === toToken"
...
export class ConvertModalComponent {
  ...
  async executeConversion(): Promise<void> {
    ...
    try {
      ...
      this.successMessage.set(`Converted ${this.fromAmount} ${this.fromToken} to ${this.toToken}!`);
